...
Integration tests use  https://www.testcontainers.org/[Testcontainers library]
which uses https://docs.docker.com/machine/install-machine/[Docker Machine].
Helpful installation instructions for Mac users: https://stackoverflow.com/a/49719638/158257
